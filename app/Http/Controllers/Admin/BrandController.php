...
class BrandController extends Controller
{
    ...
    {    
            ...
            $data['header_title'] = "Neue Marke hinzufügen";
    ...
    public function insert (Request $request)
    {
      ...
      request()->validate([
       ...
       return redirect('admin/brand/list')->with('success', "Marke erfolgreich erstellt");
    }
    ...
    {    
            ...
            $data['header_title'] = "Marke bearbeiten";
    ...
    public function update($id, Request $request)
    {
       ...
       $brand->save();
       return redirect('admin/brand/list')->with('success', "Marke erfolgreich aktualisiert");
    }
    ...
    public function delete($id)
    {
        ...
        $brand -> is_delete = 1;
        $brand->save();
        return redirect()->back()->with('success', "Marke erfolgreich gelöscht");
     }
