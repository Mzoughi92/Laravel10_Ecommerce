...
class ProductController extends Controller
{
    ...
    public function add()
    {    
            $data['header_title'] = "Produkt hinzufügen";
 ...
 {    
     $product = ProductModel::getSingle($product_id);
        ...
        if(!empty($product))
        {
         ...
         $data['header_title'] = "Produkt bearbeiten";
...
if(!empty($image->getLogo()))
{
    ...
    return redirect()->back()->with('success', "Produktbild erfolgreich gelöscht");
}
$image->delete();
}
    ...
    public function delete($product_id)
    {
        ...
        $product -> is_delete = 1;
        $product ->save();
        return redirect()->back()->with('success', "Produkt erfolgreich gelöscht");
     }
