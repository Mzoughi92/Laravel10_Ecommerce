<div class="mobile-menu-container">
    <div class="mobile-menu-wrapper">
        ...
        <form action="#" method="get" class="mobile-search">
            <label for="mobile-search" class="sr-only">Suchen</label>
            <input type="search" class="form-control" name="mobile-search" id="mobile-search" placeholder="Suchen..." required>
