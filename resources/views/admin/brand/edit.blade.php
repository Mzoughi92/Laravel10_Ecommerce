                            ...
                            <div class="row">
                                <div class="col-12">
                                     <div class="card">
                                        ...
                                        <h3 class="card-title">Brand aktualisieren</h3>
                                        </div>


                                    <div class="card card-primary">
                                        
                                        <form action="{{  url('admin/brand/update/'.$getRecord->id) }}" method="post" enctype="multipart/form-data">
                                           {{ csrf_field() }}
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" required value="{{ old('slug', $getRecord->slug) }}" name="slug" placeholder="slug  URL eingeben" >
