                    ...
                    <div class="col-12">
                      <div class="card">
                        <div class="card-header">
                          <h3 class="card-title">Brand Liste</h3>
                          ...
                          <div class="card-tools">
                            <div class="input-group input-group-sm" style="width: 150px;">
                              ...
                              <div class="col-sm-16">
                                ...
                                <a href="{{ url('admin/brand/add')}}" class="btn btn-primary">Brand hinzufügen </a>
                              </div>
                            </div>
                          </div>
                        </div>
                              ...
                              <tr>
                                ...
                                <td><center>
                                  ...
                                  @endif
                                    ...
                                    <td>  <center>
                                        <a href="{{ url('admin/brand/edit/'.$value->id) }}" class="btn btn-primary"> <i class="fas fa-pencil-alt"></i> Bearbeiten</a>
                                        <a href="{{ url('admin/brand/delete/'.$value->id) }}" class="btn btn-danger"> <i class="fas fa-trash"></i>  Löschen</a>
                                     </center>
                                      </td>
                              </tr>
