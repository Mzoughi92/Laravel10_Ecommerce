                    ...
                    <div class="col-12">
                      <div class="card">
                        <div class="card-header">
                          <h3 class="card-title">Gutschein Code Liste</h3>
                          ...
                          <table class="table table-hover">
                            <thead>
                              <tr>
                                ...
                                <th><center>Prozent/Betrag</center></th>
                                <th><center>Ablaufdatum</center></th>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><center>{{ $value->type }}</center></td>
                                <td><center>{{ $value->percent_amount }}</center></td>
                                <td><center>{{ $value->expire_date }}</center></td>
                                <td><center>
                                  @if($value->status == 0)
                                  ...
                                  @endif
                                    ...
                                    <td>  <center>
                                        <a href="{{ url('admin/discount_code/edit/'.$value->id) }}" class="btn btn-primary"> <i class="fas fa-pencil-alt"></i>  Bearbeiten</a>
                                        <a href="{{ url('admin/discount_code/delete/'.$value->id) }}" class="btn btn-danger"> <i class="fas fa-trash"></i>  Löschen</a>
                                     </center>
                                      </td>
                              </tr>
