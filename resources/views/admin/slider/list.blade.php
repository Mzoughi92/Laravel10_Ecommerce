                    ...
                    <div class="col-12">
                      <div class="card">
                        <div class="card-header">
                          <h3 class="card-title">BannerListe</h3>
                          ...
                          <table class="table table-hover">
                            <thead>
                              <tr>
                                ...
                                <th><center>Beschreibung2</center></th>
                                <th><center>Status</center></th>
                                <th><center>Erstellet von </center></th>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><center><img src="{{ asset('uploads') }}/{{ $value->photo }}" width="80" height="60" alt=""></center></td>
                                <td><center>{{ $value->description }}</center></td>
                                <td><center>{{ $value->description2 }}</center></td>
                                <td><center>
                                  @if($value->status == 0)
                                ...
                                <td><center><b>{{ $value->created_by_name }}</b></center></td>
                                    ...
                                    <td>  <center>
                                        <a href="{{ url('admin/slider/edit/'.$value->id) }}" class="btn btn-primary"> <i class="fas fa-pencil-alt"></i>  Bearbeiten</a>
